...
#'   2. You can provide named vectors of dates, where the names correspond to the names of the facets, in order to
#'      rebase a facetted chart
#'
#' @param ... either a single vector of dates, or, named vectors of dates. See examples.
#'
#' @return a list
#'
#' @export
...
#'
#' # if you are using a facetted chart, and wish to rebase each facet with different dates, then you can call this
#' # method, naming each vector of dates with the name of the facet. If there are facet's that you don't need to rebase
#' # you can simply ignore them. For example, if you had a chart with facets "a", "b", and "c", and you wanted to rebase
#' # "a" on the 1^st^ January 2020, and "b" on the 22^nd^ March 2020:
#'
