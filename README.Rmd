...
right and instead are a `c` this because you are running the old version v0.1 of the package.  Please install the latest version v0.2 to resolve this.  
...
The package supports the NHS's ['Making Data Count'][mdc] programme.
...
This project is released with a Contributor [Code of Conduct](https://github.com/nhs-r-community/NHSRplotthedots/blob/main/CODE_OF_CONDUCT.md). 
