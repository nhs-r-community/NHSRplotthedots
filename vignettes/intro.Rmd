...
spc(stable_set, valueField = "breaches", dateField = "period", improvementDirection = "decrease")
...
spc(change_set, valueField = "breaches", dateField = "period", improvementDirection = "decrease", rebase = "rebased")
```
